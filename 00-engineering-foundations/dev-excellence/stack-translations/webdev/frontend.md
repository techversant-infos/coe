# Frontend Stack Translation â€” Developer Excellence Curriculum
...
> **Status:** Draft for pilot-batch review â€” v0.3.
...
- **What changes in this stack** â€” the diff from the master, *not* a restatement of the topic. If you read the master, this is the only new information you need.
- **Mini-task variant** â€” the master's mini-task, rewritten for the frontend context.
- **Watch** â€” one verified YouTube link (provided by your tech lead) on this exact topic. If the link is missing, search YouTube for the topic and pick a video under 15 minutes from a known channel.

---

## Topic 1 â€” Clean Code Fundamentals
...
**Watch:** Search YouTube for "clean code functions Uncle Bob" â€” pick a video under 10 min.

---

## Topic 2 â€” Control Flow & Logic Clarity
...
**Watch:** Search YouTube for "guard clauses early return" â€” pick a video under 10 min.

---

## Topic 3 â€” DRY vs. WET

**What changes in this stack:** Frontend has a strong over-abstraction temptation â€” the "shared component" that takes 12 props and has 8 conditional branches is the classic smell. Rule of three still applies. A *good* frontend abstraction has a single visual identity (`<Button>`, `<Input>`, `<Modal>`). A *bad* one is where you'd have to look at the call site to know what it looks like.
...
**Watch:** Search YouTube for "wrong abstraction Sandi Metz" â€” pick the talk excerpt.

---

## Topic 4 â€” Basic Error Handling

**What changes in this stack:** Two error surfaces â€” the *user* (a friendly "We couldn't load that" message) and the *developer* (a console log with context). "Fail fast" often means: don't optimistically update if the underlying call will fail; don't render a half-loaded screen â€” show the error UI or the loading UI, not a jumble. Use the framework's error-boundary pattern to keep the boundary clean.
...
**Watch:** Search YouTube for "react error boundaries" â€” pick a 5â€“10 min video.

---

## Topic 5 â€” SOLID Principles (Core)

**What changes in this stack:** SOLID maps to *component design*, not class design. S = one component, one job. O = extend by composition or by adding a prop, not by editing. L = polymorphic components that can be swapped. I = small prop interfaces â€” split a 12-prop component. D = inject dependencies as props or context, don't `import` them inside the component body.
...
**Watch:** Search YouTube for "SOLID principles explained" â€” pick a video under 10 min.

---

## Topic 6 â€” Separation of Concerns (SoC)

**What changes in this stack:** A component should not also be the data fetcher, the business-logic container, and the layout. Cure: keep the visual concern in the component, the data concern in a hook or data layer, the business logic in a service module. The "thin component" is the frontend equivalent of the "thin controller" â€” orchestrates, doesn't decide. A component over ~50 lines is doing more than one concern.
...
**Watch:** Search YouTube for "container presentational pattern" â€” pick a 5â€“10 min video.

---

## Topic 7 â€” Dependency Injection & IoC
...
**Watch:** Search YouTube for "composition over inheritance" â€” pick a video under 15 min.

---

## Topic 9 â€” Design Thinking for Engineering

**What changes in this stack:** The "user" is more than the end user â€” it's the developer who will *use* the component (`<UserCard>` consumer) and the designer who will *theme* it. Change scenarios: "If we add a dark mode, what changes?" "If we add a new locale, what changes?" "If the API adds a new field, what changes?" Variability points = props and design tokens. Stable part = visual identity.
...
**Watch:** Search YouTube for "design thinking software engineering" â€” pick a 5â€“10 min video.

---

## Topic 10 â€” Trade-off Analysis
...
**Watch:** Search YouTube for "value objects typescript" â€” pick a 10â€“15 min video.

---

## Topic 12 â€” RESTful API Design Principles
...
**Watch:** Search YouTube for "REST API design best practices" â€” pick a 10â€“15 min video.

---

## Topic 13 â€” Validation & Boundary Protection

**What changes in this stack:** The "boundary" in the frontend is *every input from the user* (form fields, URL params, file uploads, drag-and-drop). The server is the last line of defense, but the client is the *first* â€” and a good first line catches most of the bad input before a round trip. Validate at the boundary: a form handler validates the form, a route loader validates URL params, a file upload handler validates the file. Re-validate on the server; never trust the client.
...
**Watch:** Search YouTube for "form validation client server" â€” pick a 10â€“15 min video.

---

## Topic 14 â€” Performance Awareness

**What changes in this stack:** The frontend "N+1" is a *re-render* â€” a list of 100 items that re-renders because one item changed. Fix: memoization, virtualization (only render what's on screen), stable references (don't create a new object identity on every render). "Caching basics" map to client-side caching (data layer / state management). "Measure-first" applies to the framework's profiler.
...
**Watch:** Search YouTube for "testing javascript Kent C Dodds" â€” pick a 5â€“10 min video.

---

## Topic 16 â€” Writing Testable Code
...
**Watch:** Search YouTube for "code review best practices Google" â€” pick a 10â€“15 min video.

---

## Topic 19 â€” Code Review Checklist (Standardized)
...
**Watch:** Search YouTube for "accessibility frontend developers" â€” pick a 10â€“15 min video.

---

## Topic 20 â€” Engineering Ethics & Ownership
...
**Watch:** Search YouTube for "ethics of software engineering" â€” pick a 10â€“15 min video.

---

## Phase 7 â€” Senior Developer Mindset (Lead Track)
...
**Watch:** Search YouTube for "how to write ADR Michael Nygard" â€” pick a 10â€“15 min video.
...
| Field | Value |
|---|---|
| Document | Frontend Stack Translation â€” Developer Excellence Curriculum |
