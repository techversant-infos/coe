...
- ** New joiner (13 months in)** start at [Phase 1](./curriculum.md#phase-1-foundational-coding-discipline-beginner). Don't try to read it all at once. Pick *one* topic per week, apply it to your real PRs, and ask for code review on the change.
- ** Pilot batch planner** start with [how-to-teach.md](./how-to-teach.md). It defines the format (one evolving codebase, live refactor, before/after). Pick 35 developers, run for 68 weeks, revisit at Week 2.
...
| Path | When to use it |
|---|---|
| [React path](../../01-software-engineering/web-development/frontend/react/intermediate.md) | Before this curriculum gives you a stack to *apply* the discipline to |
