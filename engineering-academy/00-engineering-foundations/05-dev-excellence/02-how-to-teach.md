...
> **Audience:** the *facilitator* the senior developer or tech lead who runs the pilot batch. Not a learner doc.
> **Read alongside:** [01-curriculum.md](./01-curriculum.md) (the content) + [90-gap-analysis.md](./90-gap-analysis.md) (what's deliberately skipped, for context).
...
The learner-facing curriculum does not include team-level metrics that's a manager concern, not a learner concern. If you're running a pilot and need to report up, the metrics to track are:

- **PR cycle time** should decrease for senior developers (cleaner code lands faster on first review)
- **Defect escape rate** should decrease (testable, refactored code is easier to verify)
- **Code-review comment quality** should improve (objective questions, not "this is bad")
- **Tech-debt awareness** should increase (developers flag the debt *they* create)
- **Mentoring hours** should become a tracked activity, not an undocumented one
...
| Version | 0.1 (initial extracted from 01-curriculum.md v0.3) |
| Owner | CoE Web Working Group |
| Review Cycle | Quarterly |
| Status | Draft for pilot-batch review |
| Related | [01-curriculum.md](./01-curriculum.md), [README.md](./README.md), [90-gap-analysis.md](./90-gap-analysis.md) |
