...
This is the **foundation track**. If your team's goal is Next.js (see [../nextjs/intermediate.md](../nextjs/intermediate.md)), this path comes first. It covers React 19.x, JSX, components, state, effects, custom hooks, forms, API integration, testing, and production patterns all written for backend engineers who read JavaScript but haven't built a frontend professionally.
...
7. **Then move to Next.js.** This path feeds directly into [../nextjs/intermediate.md](../nextjs/intermediate.md). Once you've completed this path, the Next.js path will feel like a natural extension not a completely different world.
