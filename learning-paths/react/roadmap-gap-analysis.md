...
| **Styling** (Tailwind, CSS Modules, CSS-in-JS) | ✅ | Tailwind + shadcn/ui in [Phase 8](./intermediate.md#phase-8--production-patterns-and-project-structure); CSS Modules allowed as project exception |
...
| **Internationalization** (React Intl, i18next) | ⚠️ partial | [Phase 8](./intermediate.md#phase-8--production-patterns-and-project-structure) — explicit "out of scope, see CoE i18n policy" pointer. i18n policy itself is a TODO. |
...
| **PWA / Service Workers** | ⚠️ partial | [Phase 8](./intermediate.md#phase-8--production-patterns-and-project-structure) — explicit "out of scope, see CoE PWA guide" pointer. PWA guide itself is a TODO. |
